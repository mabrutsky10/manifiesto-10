...
// This will automatically import all PNG files from the conectar folder
const imageModules = import.meta.glob('../img/conectar/*.png', { eager: true }) as Record<string, { default: string }>;
...
// Import video
const videoModule = import.meta.glob('../img/conectar/*-optimized.mp4', { eager: true }) as Record<string, { default: string }>;
...
export default function Conectar() {
  ...
  const description = t.rights.conectar.lines;
